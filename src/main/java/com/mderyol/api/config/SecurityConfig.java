...
import com.mderyol.api.security.RestAuthenticationEntryPoint;
import com.mderyol.api.security.TokenAuthenticationFilter;
import com.mderyol.api.security.oauth2.CustomOAuth2UserService;
import com.mderyol.api.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.mderyol.api.security.oauth2.OAuth2AuthenticationFailureHandler;
import com.mderyol.api.security.oauth2.OAuth2AuthenticationSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().csrf()
				...
				.antMatchers("/", "/error", "/api/*/{id}", "/api/m2m/**").permitAll()
